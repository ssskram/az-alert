...
const fiveHundo = app => {
  fetch(
    "https://azureproxy.azurewebsites.us/metrics/fiveHundo?minutes=10&resourceGroup=" +
      app.resourceGroup +
      "&appName=" +
      app.name,
    {
...
const fourHundo = app => {
  fetch(
    "https://azureproxy.azurewebsites.us/metrics/fourHundo?minutes=10&resourceGroup=" +
      app.resourceGroup +
      "&appName=" +
      app.name,
    {
